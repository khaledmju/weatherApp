    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            getWeatherCondition(weatherModel.weatherCondition),
            getWeatherCondition(weatherModel.weatherCondition)[300]!,
            getWeatherCondition(weatherModel.weatherCondition)[50]!,
          ],
